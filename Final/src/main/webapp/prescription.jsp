...
<header class="w3-container w3-red w3-center" style="padding:40px 16px">
 ...
 <div><center><label for='massage'>選擇預約日期：</label>
...
<center><label for='massage' name="time">選擇時間：</label>
<select>
<option>請選擇</option>
  ...
  <label for="cnumber1">慢性病卡號1：</label>
  <input type="text"  name="cnumber1"><br><br>
  <label for="cnumber2">慢性病卡號2：</label>
  <input type="text"  name="cnumber2"><br><br>
  <label for="cnumber3">慢性病卡號3：</label>
  <input type="text"  name="cnumber3"><br><br>
